...
eye  <- read_csv(here::here("data","vocoded_pupil.csv" ))
...
-   Forward or backward (you choose)
    -   Model 1: Null (unconditional means) model (ICC)
    ...
    -   Model 2: full (maximal) model
        ...
        -   if non-convergence (pay attention to warning messages):
            ...
            -   Use `brms`
-   Model 3 (optional): fixed effects
