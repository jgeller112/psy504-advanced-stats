...
::: {.column width="50%"}
![](annotations.png){fig-align="center" width="38.36in"}
:::
:::
...
-   Using the assigned readings
    ...
    -   Examples and applications
        ...
        -   Walk us through an example from one of the articles/readings or own reserch
        -   
...
-   **No HW just readings to help orient you to the talks**
