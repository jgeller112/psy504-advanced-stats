...
-   Can write LaTeX in .qmd files as well! For a full line formula, use two \$\$ dollar signs at the begining and end of your LaTeX:
...
::: callout-note
Question - We want to *decrease* $f$, so what should we do to $x$ and $y$? - Which one should we decrease more? $x$ or $y$
:::
