...
knitr::opts_chunk$set(
  #fig.width=20, fig.height=12, fig.retina=4,
  out.width = "90%",
...
.pull-right[
```{r, echo=FALSE, fig.aligh = "center", out.width="100%", fig.width=16, fig.height=12}
...
```{r, echo=FALSE, fig.align='center', fig.width=12, fig.height=16, out.width="50%"}
ggemmeans(health_m, terms=c("Age")) %>%
  plot()
```
...
.pull-right[
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.width=16, fig.height=12}
