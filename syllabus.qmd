...
4.  Non-Gaussian statistics: Generalized Linear Model, Poisson regression, ordinal regression, multinomial regression
5.  Beyond Null Hypothesis Significance Testing (NHST): Structural equation models, Bayesian hypothesis testing
6.  Dimension reduction: Exploratory factor analysis, principal components analysis (PCA), cluster analysis, confirmatory factor analysis (CFA)
7.  Time-based analyses: survival modeling and growth curve modeling
8.  Meta-analysis
